...
const TrivagoLogo = props => (
	<Svg viewBox="0 0 80 24" {...props} style={{ width: 'auto' }}>
		<path fill="#F48F00" d="M25.1 5.4h4l3.1 8.3h.1l2.8-8.3h3.8l-4.8 12.2h-4z" />
		<path
			fill="#007FAD"
			d="M10.4 8.4H6.7v4.1c0 .7.1 1.6.7 2 .6.4 1.5.3 2.2.2.4 0 .6-.1.8-.3v3.1c-.5.1-.9.2-1.4.3-2.6.3-6.4-.2-6.4-3.6V8.4H0v-3h2.6V1.8h4.1v3.6h3.7v3zm10.5-3h3.7v12.2h-3.7V5.4zm-.2-3.3c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2c-1 0-2-.9-2-2"
		/>
		<path
			fill="#C94A30"
		...
		<path
			fill="#CDD0D2"
			d="M77.7 8.8c-.9 0-1.6-.7-1.6-1.6 0-.9.7-1.6 1.6-1.6.9 0 1.6.7 1.6 1.6.1.8-.7 1.6-1.6 1.6m0-3.7c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.8-2-2-2m.3 1.7c0-.2-.2-.2-.4-.2h-.2V7h.1c.3 0 .5 0 .5-.2m.8 1.3h-.6l-.5-.7h-.2v.7H77V6.2h1.1c.4.1.6.5.3.9-.1.1-.2.2-.3.2l.7.8z"
		/>
		<path
			fill="#C94A30"
